  ...
  "README.md": `
...

    {
      ...
      "experience": "${(() => {
        ...
        return `${String(years).padStart(2, '0')}:${String(months).padStart(2, '0')}:${String(days).padStart(2, '0')}:${String(hours).padStart(2, '0')}:${String(minutes).padStart(2, '0')}:${String(seconds).padStart(2, '0')}:${String(milliseconds).padStart(3, '0')}`;
      })()}"
    }
  `,
  "about.txt": `
